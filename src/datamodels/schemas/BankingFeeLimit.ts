...
export class BankingFeeLimit implements DataObject {
    @Prop({enum: [DominicanLotteryPrizes.name, UsLotteryPrizes.name, BrasilPrizes.name]}) playType?: DominicanLotteryPrizes | UsLotteryPrizes | BrasilPrizes; // TODO check prop
