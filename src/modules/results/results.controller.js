...
var result_dto_1 = require("@results/dtos/result.dto");
var role_1 = require("@database/datamodels/enums/role");
var roles_guard_1 = require("@auth/guards/roles.guard");
var ResultsController = /** @class */ (function () {
    function ResultsController(resultService) {
        this.resultService = resultService;
    }
    ResultsController.prototype.getAll = function () {
        return this.resultService.getAll();
    };
    ResultsController.prototype.create = function (dto, loggedUser) {
        return this.resultService.create(dto, loggedUser);
    };
    ResultsController.prototype.get = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resultService.get(id)];
    ...
    ], ResultsController.prototype, "get");
    ResultsController = __decorate([
        swagger_1.ApiTags('results'),
        common_1.Controller('results'),
