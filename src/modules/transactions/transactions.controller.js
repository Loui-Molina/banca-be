...
var transaction_dto_1 = require("@transactions/dtos/transaction.dto");
...
var TransactionController = /** @class */ (function () {
    ...
    TransactionController.prototype.getAll = function (loggedUser) {
        return this.transactionService.getAll(loggedUser);
    };
    // eslint-disable-next-line @typescript-eslint/no-explicit-any,@typescript-eslint/explicit-module-boundary-types
    TransactionController.prototype.getFiltered = function (q, value) {
        return this.transactionService.getFiltered(q, value);
    };
    TransactionController.prototype.createTransactionAdmin = function (dto, loggedUser) {
        return this.transactionService.createTransactionAdmin(dto, loggedUser);
    };
    TransactionController.prototype.createTransactionConsortium = function (dto, loggedUser) {
        return this.transactionService.createTransactionConsortium(dto, loggedUser);
    };
    TransactionController.prototype.get = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.transactionService.get(id)];
    ...
    ], TransactionController.prototype, "getAll");
    __decorate([
        common_1.Get('search'),
        swagger_1.ApiFoundResponse({
            description: const_app_1.ConstApp.DEFAULT_GET_OK,
            type: transaction_1.Transaction
        }),
        roles_decorator_1.Roles(role_1.Role.admin),
        __param(0, common_1.Query('q')), __param(1, common_1.Query('value'))
    ], TransactionController.prototype, "getFiltered");
    __decorate([
        common_1.Post('create/transaction/admin'),
    ...
    ], TransactionController.prototype, "createTransactionAdmin");
    __decorate([
        common_1.Post('create/transaction/consortium'),
        swagger_1.ApiCreatedResponse({
            description: const_app_1.ConstApp.DEFAULT_POST_OK,
            type: transaction_1.Transaction
        }),
        ...
        __param(0, common_1.Body()), __param(1, auth_user_decorator_1.AuthUser())
    ], TransactionController.prototype, "createTransactionConsortium");
    __decorate([
        common_1.Get(':id'),
        swagger_1.ApiFoundResponse({
            description: const_app_1.ConstApp.DEFAULT_GET_OK,
    ...
    ], TransactionController.prototype, "get");
