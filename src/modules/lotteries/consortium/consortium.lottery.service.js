...
exports.ConsortiumLotteryService = void 0;
...
var ConsortiumLotteryService = /** @class */ (function () {
    function ConsortiumLotteryService(lotteryModel, consortiumLotteryModel, consortiumModel) {
        this.lotteryModel = lotteryModel;
        this.consortiumLotteryModel = consortiumLotteryModel;
        this.consortiumModel = consortiumModel;
    }
    ConsortiumLotteryService.prototype.getAll = function (loggedUser) {
        return __awaiter(this, void 0, void 0, function () {
            var consortium, lotteries;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.consortiumModel.find({ ownerUserId: loggedUser._id })];
                    case 1:
                        consortium = (_a.sent()).pop();
    ...
    ConsortiumLotteryService.prototype.update = function (dto, loggedUser) {
        return __awaiter(this, void 0, void 0, function () {
            var lottery, consortium, consortiumLottery, index;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(dto._id)];
                    case 1:
                        lottery = _a.sent();
                        return [4 /*yield*/, this.consortiumModel.find({ ownerUserId: loggedUser._id })];
                    case 2:
                        consortium = (_a.sent()).pop();
                        if (!consortium) {
                        ...
                        dto.prizeLimits.map(function (item) {
                            item.creationUserId = loggedUser._id;
                            item.modificationUserId = loggedUser._id;
                        });
                        //Creating Betting Limits
                        dto.bettingLimits.map(function (item) {
                            item.creationUserId = loggedUser._id;
                            item.modificationUserId = loggedUser._id;
                        });
                        consortiumLottery = new this.consortiumLotteryModel({
                        ...
                        index = consortium.consortiumLotteries.findIndex(function (item) { return item.lotteryId.toString() === lottery._id.toString(); });
                        if (index !== -1) {
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/, lottery];
                }
            });
        });
    };
    ConsortiumLotteryService.prototype.get = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.lotteryModel.findById(id).exec()];
            });
        });
    };
    ConsortiumLotteryService = __decorate([
        common_1.Injectable(),
        __param(0, mongoose_1.InjectModel(lottery_1.Lottery.name)),
        __param(1, mongoose_1.InjectModel(consortium_lottery_1.ConsortiumLottery.name)),
        __param(2, mongoose_1.InjectModel(consortium_1.Consortium.name))
    ], ConsortiumLotteryService);
    return ConsortiumLotteryService;
}());
exports.ConsortiumLotteryService = ConsortiumLotteryService;
