...
var any_exception_filter_1 = require("@common/filters/any.exception.filter");
var validation_pipe_1 = require("@common/pipes/validation.pipe");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, options, document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    swagger_1.SwaggerModule.setup(app.get('ConfigService').get('APP_SWAGGER_SETUP'), app, document);
